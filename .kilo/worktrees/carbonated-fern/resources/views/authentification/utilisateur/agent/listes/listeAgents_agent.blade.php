...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des agents chez l'agent</title>
        <!-- Bootstrap Icons -->
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('accueilAgent') }}">
                            <span class="icon">
                                <ion-icon name="home-outline"></ion-icon>
                            </span>
                            <span class="title">Accueil de l'agent</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('listeClients_agent') }}">
                            <span class="icon">
                    ...
                    <li>
                        <a href="{{ route('listeAgents_agent') }}">
                    ...
                    <li>
                        <a href="{{ route('listeAnnonces_agent') }}">
                            <span class="icon">
                    ...
                    <li>
                        <a href="{{ route('listeLocalisations_agent') }}">
                            <span class="icon">
                                <ion-icon name="chatbubble-outline"></ion-icon>
                            </span>
                    ...
                    <li>
                        <a href="{{ route('listeElectromenagers_agent') }}">
                            <span class="icon">
                                <ion-icon name="chatbubble-outline"></ion-icon>
                            </span>
                    ...
                    <li>
                        <a href="{{ route('listeOrdinateurs_agent') }}">
                            <span class="icon">
                                <ion-icon name="chatbubble-outline"></ion-icon>
                            </span>
                    ...
                    <li>
                        <a href="{{ route('listeMagasins_agent') }}">
                            <span class="icon">
                    ...
                    <li>
                        <a href="{{ route('listeServices_agent') }}">
                            <span class="icon">
                                <ion-icon name="settings-outline"></ion-icon>
                            </span>
                    ...
                    <li>
                        <a href="{{ route('listeFormations_agent') }}">
                            <span class="icon">
                                <ion-icon name="settings-outline"></ion-icon>
                            </span>
                    ...
                    <li>
                        <a href="{{ route('listeTransactions_agent') }}">
                            <span class="icon">
               ...
               <div class="main">
                    ...
                    <form action="/searchAgent_agent" class="form-inline">
                    <div class="topbar">
                    <div class="toggle">
                    ...
                    <font color="white" size="6">Agent: <strong><u>EVE JORDANIE</u></strong></font>
                ...
                <div class="cardBox">
                    ...
                    <a href="{{ route('listeClients_agent') }}" style="text-decoration: none; color: inherit;">
                    ...
                    <a href="{{ route('listePaniers_agent') }}" style="text-decoration: none; color: inherit;">
                        <div class="card">
                            <div>
                    ...
                    <a href="{{ route('listeAnnonces_agent') }}" style="text-decoration: none; color: inherit;">
                        <div class="card">
                            <div>
                    ...
                    <a href="{{ route('listeTransactions_agent') }}" style="text-decoration: none; color: inherit;">
                        <div class="card">
                            <div>
                ...
                <div class="details">
                    <div class="recentOrders">
                        <div class="cardHeader">
                            ...
                            <a href="{{ route('listeDetailsAgents_agent') }}" class="btn">
                              Voir les détails des agents
                            </a>
                        </div>
