...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>CLIENT: Page des catégories </title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="card-container" style="display: flex; justify-content: center; align-items: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                ...
                <!-- Second card -->
                <a href="{{ url('/listeServiceElectronique') }}" style="text-decoration: none;">
                    <div class="div-card" style="margin: 5px; text-align: center; width: 300px; border: 1px solid #ddd; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgb(0, 0, 118); background-color: white; cursor: pointer; transition: all 0.3s;">
                        <img src="{{ asset('image/Final_electronique.jpg') }}" alt="Card 2 Image" style="width: 100%; height: 350px;">
                        <h3 style="margin: 10px 0; font-size: 18px; color: rgb(0, 0, 118);"><b><font size="7">Catégories électroniques</font></b></h3>
                    </div>
                </a>
                <script>
                    function listeServiceElectronique() {
                        window.location.href = "{{ url('/listeServiceElectronique') }}";
                    }
                </script>

                <!-- First card -->
                <a href="{{ url('/listeServiceOrdinateur') }}" style="text-decoration: none;">
                    <div class="div-card" style="margin: 5px; text-align: center; width: 300px; border: 1px solid #ddd; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgb(0, 0, 118); background-color: white; cursor: pointer; transition: all 0.3s;">
                        <img src="{{ asset('image/ordinateur.jpg') }}" alt="Card 1 Image" style="width: 100%; height: 350px;">
                        <h3 style="margin: 10px 0; font-size: 18px; color: rgb(0, 0, 118);"><b><font size="7">Catégories ordinateurs</font></b></h3>
                    </div>
                </a>
                <script>
