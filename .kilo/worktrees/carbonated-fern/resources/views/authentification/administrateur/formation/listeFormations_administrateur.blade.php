                                             ...
                                             <tr>
                                                    ...
                                                    <td>                                                        
                                                        ...
                                                        <span class="status pending">
                                                            <a href="{{ route('editFormation_administrateur', $formation->id_formation) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cette formation vidéo ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteFormation_administrateur/' . $formation->id_formation) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette formation vidéo ?');">
                                        ...
                                        @foreach($formations1 as $formation1)
                                                <tr>
                                                    ...
                                                    <td>                                                        
                                                        ...
                                                        <span class="status pending">
                                                            <a href="{{ route('editFormation1_administrateur', $formation1->id_formation1) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cette formation pdf ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteFormation1_administrateur/' . $formation1->id_formation1) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette formation pdf ?');">
                                                                <font color="white"><i class="bi bi-trash"></i></font>
                                                            </a>
                                                        </span>                                                         
                                                    </td> 
