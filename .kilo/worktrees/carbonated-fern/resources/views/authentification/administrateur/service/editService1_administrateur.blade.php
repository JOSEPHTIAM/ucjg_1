                ...
                <div class="form-left">  
                    ...
                    <form action="{{ route('updateService1_administrateur', $service1->id_service1) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_ordinateur" id="id_ordinateur" class="form-control">
                                @foreach(\App\Models\Ordinateur::all() as $ordinateur)
                                    <option value="{{ $ordinateur->id_ordinateur }}" {{ $service1->id_ordinateur == $ordinateur->id_ordinateur ? 'selected' : '' }}>
                                        "" {{ $ordinateur->nom_ordinateur }} "" de {{ $ordinateur->puissance_ordinateur }}Watts -- {{ $ordinateur->tension_ordinateur }}Volts
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_localisation" id="id_localisation" class="form-control" required>
                                @foreach(\App\Models\Localisation::all() as $localisation)
                                    <option value="{{ $localisation->id_localisation }}" {{ $service1->id_localisation == $localisation->id_localisation ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="description_service" name="description_service" value="{{ old('description_service', $service1->description_service) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="prix_service" name="prix_service" value="{{ old('prix_service', $service1->prix_service) }}" required min="0" oninput="calculateTotal()">
                            @error('prix_service')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_magasin" id="id_magasin" class="form-control" required onchange="calculateTotal()">
                                @foreach(\App\Models\Magasin::all() as $magasin)
                                    <option value="{{ $magasin->id_magasin }}" {{ $service1->id_magasin == $magasin->id_magasin ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select name="matricule" id="matricule" class="form-control" required>
                                @foreach(\App\Models\User::where('role', 'Administrateur')->orWhere('role', 'Agent')->get() as $user)
                                    <option value="{{ $user->matricule }}" {{ $service1->matricule == $user->matricule ? 'selected' : '' }}>
