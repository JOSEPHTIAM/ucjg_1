                    ...
                    <div class="form-left">  
                         ...
                         <form action="{{ route('updateOrdinateur_administrateur', $ordinateur->id_ordinateur) }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="nom_ordinateur" name="nom_ordinateur" value="{{ old('nom_ordinateur', $ordinateur->nom_ordinateur) }}" required>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="processeur" name="processeur" value="{{ old('processeur', $ordinateur->processeur) }}">
                                   @error('processeur')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="disque" name="disque" value="{{ old('disque', $ordinateur->disque) }}" required>
                                   @error('disque')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="number" class="form-control" id="ram" name="ram" value="{{ old('ram', $ordinateur->ram) }}" required>
                                   @error('ram')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="core" name="core" value="{{ old('core', $ordinateur->core) }}" required>
                                   @error('disque')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
