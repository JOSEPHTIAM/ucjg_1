        ...
        <style>
            ...
            * {
            ...
            .main {
                ...
                background: var(--white);
                transition: 0.5s;
                background-image: url("{{ asset('image/ordinateur.jpg') }}");
                                             ...
                                             <tr>
                                                    ...
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="{{ route('editOrdinateur_administrateur', $ordinateur->id_ordinateur) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet appareil ordinateur ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteOrdinateur_administrateur/' . $ordinateur->id_ordinateur) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet appareil ordinateur ?');">
