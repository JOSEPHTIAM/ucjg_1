          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="{{ route('storeOrdinateur_administrateur') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="file" id="image_ordinateur" name="image_ordinateur" class="form-control" value="{{ old('image_ordinateur') }}">
                                   </div>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="nom_ordinateur" name="nom_ordinateur" class="form-control" value="{{ old('nom_ordinateur') }}" placeholder="DELL" required>
                                        @error('nom_ordinateur')
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="processeur" name="processeur" class="form-control" value="{{ old('processeur') }}" placeholder="Intel 3GHZ" required>
                                        @error('processeur')
                                             <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                   </div>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="disque" name="disque" class="form-control" value="{{ old('disque') }}" placeholder="SDD 476" required>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="number" id="ram" name="ram" class="form-control" value="{{ old('ram') }}" placeholder="16" required>
                                        @error('ram')
                                             <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                   </div>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="core" name="core" class="form-control" value="{{ old('core') }}" placeholder="i7" required>
                                        @error('core')
                                             <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                   </div>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   function listeOrdinateurs_administrateur() {
                                        window.location.href = "{{ url('listeOrdinateurs_administrateur') }}";
                                   }
                                   </script>
                              </div>
                         </form>
