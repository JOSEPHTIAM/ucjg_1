     ...
     <head>
          ...
          <title>Page de modification d'agent du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               <div class="form-container">
                    ...
                    <div class="form-left">  
                         <h2>
                              <font color="#000076"><b><strong>Modification de l'agent</strong></b></font>
                         </h2>
                         @if(session('error'))
                         ...
                         <form action="{{ route('updateAgent_administrateur', $user->matricule) }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="nom_societe" name="nom_societe" value="{{ old('nom_societe', $user->nom_societe) }}">
                                   @error('nom_societe')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   <label for="numero_societe">Numéro de la société</label>
                                   <input type="number" class="form-control" id="numero_societe" name="numero_societe" value="{{ old('numero_societe', $user->numero_societe) }}">
                                   @error('numero_societe')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   <button onclick="listeAgents_administrateur()" type="reset" class="btn btn-danger">
                                   ...
                                   <script>
                                   function listeAgents_administrateur() {
