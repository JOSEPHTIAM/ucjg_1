                                                  ...
                                                  <td>
                                                    ...
                                                    <td>
                                                        <span class="status actuellement">
                                                            <a href="{{ url('/OpenClient_administrateur/' . $user->matricule) }}" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de ce client ?');">
                                                                <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status pending">
                                                            <a href="{{ route('editClient_administrateur', $user->matricule) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce client ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteClient_administrateur/' . $user->matricule) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce client ?');">
                                             ...
                                             <tr>
                                                  <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteClient_administrateur/' . $user->matricule) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?');">
                                                                <font color="white"><i class="bi bi-trash"></i></font>
                                                            </a>
                                                        </span>                                                         
                                                    </td>                                                    
