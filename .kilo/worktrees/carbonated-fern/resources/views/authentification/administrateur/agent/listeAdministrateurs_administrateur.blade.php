                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @if(isset($users))
                                                    ...
                                                    <td>{{$user->statut}}</td>
                                                       <td>
                                                            <span class="status actuellement">
                                                                 <a href="{{ url('/OpenAdministrateur_administrateur/' . $user->matricule) }}" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de cet administrateur ?');">
                                                                    <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                                 </a>
                                                            </span> &nbsp;&nbsp;
                                                            <span class="status pending">
                                                                 <a href="{{ route('editAdministrateur_administrateur', $user->matricule) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet administrateur ?');">
                                                                    <font color="white"><i class="bi bi-pencil"></i></font>
                                                                 </a>
                                                            </span> &nbsp;&nbsp;
                                                            <span class="status return">
                                                                 <a href="{{ url('/deleteAdministrateur_administrateur/' . $user->matricule) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet administrateur ?');">
                                            ...
                                            @endforeach
                                    @else
                                            @foreach(\App\Models\User::where('role', 'Administrateur')->paginate(1000) as $user)
                                                <tr>
                                                    <td>
                                                        @if($user->photo)
                                                            <img src="{{asset('storage/images'.'/'.$user->photo)}}" alt="Photo" width="50" height="50">
