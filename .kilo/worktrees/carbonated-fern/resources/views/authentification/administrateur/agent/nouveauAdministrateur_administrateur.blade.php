     ...
     <head>
          ...
          <title>Page du nouveau administrateur du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         <h2>
                              <font color="#000076"><b><strong>Nouveau administrateur</strong></b></font>
                         </h2>
                         @if(session('error'))
                         ...
                         <form action="{{ route('store_administrateur') }}" method="post" enctype="multipart/form-data">
                              @csrf
