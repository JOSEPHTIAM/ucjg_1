     ...
     <head>
          ...
          <title>Page du nouveau agent du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         <h2>
                              <font color="#000076"><b><strong>Nouveau agent</strong></b></font>
                         </h2>
                         @if(session('error'))
                         ...
                         <form action="{{ route('store_agent') }}" method="post" enctype="multipart/form-data">
                              @csrf
