          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="{{ route('storeLocalisation_administrateur') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="nom_localisation" name="nom_localisation" class="form-control" value="{{ old('nom_localisation') }}" placeholder="Entreprise" required>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="quartier_localisation" name="quartier_localisation" class="form-control" value="{{ old('quartier_localisation') }}" placeholder="Quartier" required>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="ville_localisation" name="ville_localisation" class="form-control" value="{{ old('ville_localisation') }}" placeholder="Ville" required>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="pays_localisation" name="pays_localisation" class="form-control" value="{{ old('quartier_localisation') }}" placeholder="Pays" required>
