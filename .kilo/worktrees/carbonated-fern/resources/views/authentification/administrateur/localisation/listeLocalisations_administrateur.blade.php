        ...
        <style>
            ...
            * {
            ...
            .main {
                ...
                background: var(--white);
                transition: 0.5s;
                background-image: url("{{ asset('image/localisation.jpg') }}");
                              ...
                              <tbody>
                                   @if(isset($localisations))
                                        @foreach($localisations as $localisation)
                                             <tr>
                                                    <td>{{$localisation->id_localisation}}</td>
                                                    <td>{{$localisation->nom_localisation}}</td>
                                                    <td>{{$localisation->quartier_localisation}}</td>
                                                    <td>{{$localisation->ville_localisation}}</td>
                                                    <td>{{$localisation->pays_localisation}}</td>
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="{{ route('editLocalisation_administrateur', $localisation->id_localisation) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cette localisation ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteLocalisation_administrateur/' . $localisation->id_localisation) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette localisation ?');">
