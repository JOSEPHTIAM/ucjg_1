     ...
     <head>
          ...
          <style>
               body {
                    background: url('{{ asset('image/localisation.jpg') }}') no-repeat center center;
          ...
          <div class="container">
               <div class="form-container">
                    ...
                    <div class="form-left">  
                         ...
                         <form action="{{ route('updateLocalisation_administrateur', $localisation->id_localisation) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('POST')
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="nom_localisation" name="nom_localisation" value="{{ old('nom_localisation', $localisation->nom_localisation) }}" required>
                                   @error('nom_localisation')
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="quartier_localisation" name="quartier_localisation" value="{{ old('quartier_localisation', $localisation->quartier_localisation) }}">
                                   @error('quartier_localisation')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="ville_localisation" name="ville_localisation" value="{{ old('ville_localisation', $localisation->ville_localisation) }}" required>
                                   @error('ville_localisation')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="pays_localisation" name="pays_localisation" value="{{ old('pays_localisation', $localisation->pays_localisation) }}" required>
                                   @error('pays_localisation')
                                   <div class="text-danger">{{ $message }}</div>
                                   @enderror
                              </div>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   function listeLocalisations_administrateur() {
                                        window.location.href = "{{ url('listeLocalisations_administrateur') }}";
                                   }
                                   </script>
                              </div>
                         </form>
