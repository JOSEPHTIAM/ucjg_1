        ...
        <style>
            ...
            * {
            ...
            .main {
                ...
                background: var(--white);
                transition: 0.5s;
                background-image: url("{{ asset('image/Final_electronique.jpg') }}");
                                             ...
                                             <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteElectromenager_administrateur/' . $electromenager->id_electromenager) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet appareil électromenager ?');">
