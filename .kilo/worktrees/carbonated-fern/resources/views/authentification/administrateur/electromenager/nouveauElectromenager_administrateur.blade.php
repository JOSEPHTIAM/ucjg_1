<!DOCTYPE html>
     ...
     <head>
          ...
          <style>
               body {
                    background: url('image/Final_electronique.jpg') no-repeat center center;
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="{{ route('storeElectromenager_administrateur') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" id="image_electromenager" name="image_electromenager" class="form-control" value="{{ old('image_electromenager') }}">
                                   </div>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="nom_electromenager" name="nom_electromenager" class="form-control" value="{{ old('nom_electromenager') }}" placeholder="Modem Wifi" required>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="number" id="puissance_electromenager" name="puissance_electromenager" class="form-control" value="{{ old('puissance_electromenager') }}" placeholder="42" required>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="number" id="tension_electromenager" name="tension_electromenager" class="form-control" value="{{ old('tension_electromenager') }}" placeholder="12" required>
