        ...
        <style>
            ...
            * {
            ...
            .main {
                ...
                background: var(--white);
                transition: 0.5s;
                background-image: url("{{ asset('image/Final_magasin.jpg') }}");
        ...
        <div class="container">
            <div class="navigation">
               ...
               <div class="main">
                    ...
                    <font color="rgb(0, 0, 118)" size="6">Société : <strong><u>MEMPHY.SARL</u></strong></font>
                                   ...
                                   @if(isset($magasins))
                                        @foreach($magasins as $magasin)
                                             <tr>
                                                    ...
                                                    <td>{{$magasin->stock_magasin}}</td>
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="{{ route('editMagasin_administrateur', $magasin->id_magasin) }}" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce magasin ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="{{ url('/deleteMagasin_administrateur/' . $magasin->id_magasin) }}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce magasin ?');">
