<!DOCTYPE html>
     ...
     <head>
          ...
          <style>
               body {
                    background: url('{{ asset('image/Final_magasin.jpg') }}') no-repeat center center;
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">  
                         ...
                         <form action="{{ route('updateMagasin_administrateur', $magasin->id_magasin) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('POST')
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="number" class="form-control" id="stock_magasin" name="stock_magasin" value="{{ old('stock_magasin', $magasin->stock_magasin) }}" required>
                                   @error('stock_magasin')
                              ...
                              <div class="form-group text-center">
                                   ...
                                   function listeMagasins_administrateur() {
                                        window.location.href = "{{ url('listeMagasins_administrateur') }}";
                                   }
                                   </script>
                              </div>
                         </form>
