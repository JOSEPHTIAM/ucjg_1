     ...
     <head>
          ...
          <style>
               body {
                    background: url('image/Final_magasin.jpg') no-repeat center center;
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="{{ route('storeMagasin_administrateur') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="number" id="stock_magasin" name="stock_magasin" class="form-control" value="{{ old('stock_magasin') }}" placeholder="3" required>
                                        @error('stock_magasin')
